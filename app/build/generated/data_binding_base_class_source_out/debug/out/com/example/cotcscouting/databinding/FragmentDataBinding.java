...
public final class FragmentDataBinding implements ViewBinding {
  ...
  @NonNull
  public final BarChart chartTesting;

  private FragmentDataBinding(@NonNull FrameLayout rootView, @NonNull BarChart chartTesting) {
    this.rootView = rootView;
    this.chartTesting = chartTesting;
  }
  ...
  public static FragmentDataBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.chart_testing;
      BarChart chartTesting = ViewBindings.findChildViewById(rootView, id);
      if (chartTesting == null) {
        break missingId;
      }

      return new FragmentDataBinding((FrameLayout) rootView, chartTesting);
    }
